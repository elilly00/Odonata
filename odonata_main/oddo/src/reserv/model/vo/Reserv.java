...
public class Reserv {
    ...
    public Reserv(int v_code, String status, Date check_in, Date check_out, String personnel, int rooms_code,
            String rooms_host, int user_code, int reserv_Price) {
        super();
        this.v_code = v_code;
        this.status = status;
    ...
    public String toString() {
        return "Reserv [v_code=" + v_code + ", status=" + status + ", check_in=" + check_in + ", check_out=" + check_out
                + ", personnel=" + personnel + ", rooms_code=" + rooms_code + ", rooms_host=" + rooms_host
                + ", user_code=" + user_code + ", reserv_Price=" + reserv_Price + "]";
    }
}