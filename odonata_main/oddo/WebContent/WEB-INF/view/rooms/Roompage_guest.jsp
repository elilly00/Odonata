          ...
          document.getElementById('but2').onclick = function(){
			...
			// 성인 + 아동 
      		...
      		if(checkIn == "" | checkOut == "" ) {
      			...
      			location.href="<%= request.getContextPath() %>/reservation.bo?checkIn="+checkIn+"&checkOut="+checkOut+"&personnel="+personnel+"&roomCode="+roomCode+"&userCode="+userCode+"&price="+price;
      		}
