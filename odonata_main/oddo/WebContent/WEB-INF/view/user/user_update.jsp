...
<body>
            ...
            <div class="card mask-custom">
              <div class="card-body p-5">
                <div class="my-4">
                  ...
                  <form action="<%= request.getContextPath() %>/updateUser.us" method="post" id="updateForm"
                    name="updateForm" onsubmit="return insertValidate();">
                    <div class="row">
  ...
  <script>
    $("label[for='uId']").text('아이디: 수정 불가').css({
      'color': 'green',
      'font-weight': 'bold'
    });
      ...
      if (!userEmail) {
        ...
        $.ajax({
          ...
          success: function (data) {
            console.log(data);
            if (data.trim() == '0' || (userEmail.val() + emailDomain.val() ==
