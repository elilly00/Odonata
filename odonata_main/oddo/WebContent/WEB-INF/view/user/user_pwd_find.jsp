              ...
              <div class="card mask-custom">
                <div class="card-body p-5">
                  <div class="my-4">
                    ...
                    <form action="<%= request.getContextPath() %>/pwdfind.us" method="post" id="joinForm"
                      name="joinForm" role="form">

                      <div class="form-floating form-white mb-4">
                        <input type="tel" id="id" name="id" class="form-control form-control-lg" />
                        <label class="form-label" for="uPhone">아이디</label>
                      </div>

                      <div class="form-floating form-white mb-4">
                        <input type="tel" id="name" name="name" class="form-control form-control-lg" />
                        <label class="form-label" for="uPhone">이름</label>
                      </div>

                      <div class="form-floating form-white mb-4">
                        <input type="tel" id="email" name="email" class="form-control form-control-lg" />
                        <label class="form-label" for="uPhone">이메일</label>
                      </div>
